...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = {
    ...
    { TMUX_SCROLL, KC_LALT  , KC_LGUI, KC_LCTRL, LOWER  , KC_ENT , KC_SPC , RAISE    , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX }
  },
  [_LOWER] = {
    { KC_GRV     , XXXXXXX  , XXXXXXX, XXXXXXX , XXXXXXX, XXXXXXX, XXXXXXX, KC_7     , KC_8   , KC_9   , KC_PLUS, KC_ASTR },
    { XXXXXXX    , XXXXXXX  , KC_BSPC, KC_MINS , KC_EQL , XXXXXXX, KC_DOT , KC_4     , KC_5   , KC_6   , KC_MINS, KC_SLSH },
    { KC_LPRN    , XXXXXXX  , XXXXXXX, KC_QUES , KC_BSLS, XXXXXXX, KC_0   , KC_1     , KC_2   , KC_3   , KC_PERC, KC_RPRN },
    { XXXXXXX    , XXXXXXX  , XXXXXXX, XXXXXXX , LOWER  , KC_ENT , KC_SPC , RAISE    , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX }
  },
  [_RAISE] = {
    { KC_TILD    , KC_EXLM  , KC_AT  , KC_HASH , KC_DLR , KC_PERC, KC_CIRC, KC_AMPR  , KC_ASTR, KC_LPRN, KC_RPRN, XXXXXXX },
    { XXXXXXX    , XXXXXXX  , KC_BSPC, KC_UNDS , KC_PLUS, XXXXXXX, XXXXXXX, KC_LEFT  , KC_UP  , KC_DOWN, KC_RGHT, XXXXXXX },
