...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = {
    ...
    { TMUX_SCROLL, KC_LALT  , KC_LGUI, KC_LCTRL, LOWER  , KC_ENT , RAISE  , KC_SPC   , XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT }
  },
  [_LOWER] = {
    { KC_GRV     , KC_1     , KC_2   , KC_3    , KC_4   , KC_5   , KC_6   , KC_7     , KC_8   , KC_9   , KC_0   , KC_BSPC },
    { XXXXXXX    , XXXXXXX  , XXXXXXX, KC_MINS , KC_EQL , XXXXXXX, XXXXXXX, KC_4     , KC_5   , KC_6   , KC_QUOT, XXXXXXX },
    { KC_LPRN    , XXXXXXX  , XXXXXXX, XXXXXXX , KC_BSLS, XXXXXXX, KC_0   , KC_1     , KC_2   , KC_3   , KC_UP  , KC_RPRN },
    { XXXXXXX    , XXXXXXX  , XXXXXXX, XXXXXXX , LOWER  , KC_ENT , RAISE  , KC_SPC   , KC_DOT , KC_LEFT, KC_DOWN, KC_RGHT }
  },
  [_RAISE] = {
    { KC_TILD    , KC_EXLM  , KC_AT  , KC_HASH , KC_DLR , KC_PERC, KC_CIRC, KC_AMPR  , KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC },
    { XXXXXXX    , XXXXXXX  , XXXXXXX, KC_UNDS , KC_PLUS, XXXXXXX, XXXXXXX, KC_QUES  , XXXXXXX, XXXXXXX, KC_DQUO, XXXXXXX },
    { KC_LBRC    , XXXXXXX  , XXXXXXX, XXXXXXX , KC_PIPE, XXXXXXX, XXXXXXX, XXXXXXX  , XXXXXXX, XXXXXXX, XXXXXXX, KC_RBRC },
    { SCR_SCROLL , XXXXXXX  , XXXXXXX, XXXXXXX , LOWER  , KC_ENT , RAISE  , KC_SPC   , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX }
  },
  [_ADJUST] = {
    ...
    { XXXXXXX    , XXXXXXX  , XXXXXXX, XXXXXXX , LOWER  , KC_MPLY, RAISE  , XXXXXXX  , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX }
  }
};
