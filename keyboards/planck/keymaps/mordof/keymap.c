...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = {
    ...
    { TMUX_SCROLL, KC_LALT  , KC_LGUI, KC_LCTRL, LOWER  , KC_SPC , KC_SPC , RAISE_ENT, KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT }
  },
  [_LOWER] = {
    { KC_GRV     , KC_1     , KC_2   , KC_3    , KC_4   , KC_5   , KC_6   , KC_7     , KC_8   , KC_9   , KC_0   , KC_BSPC },
    { XXXXXXX    , XXXXXXX  , XXXXXXX, KC_MINS , KC_EQL , XXXXXXX, XXXXXXX, KC_4     , KC_5   , KC_6   , KC_QUOT, KC_DEL  },
  ...
  [_RAISE] = {
    ...
    { XXXXXXX    , XXXXXXX  , XXXXXXX, KC_UNDS , KC_PLUS, XXXXXXX, XXXXXXX, KC_QUES  , XXXXXXX, XXXXXXX, KC_DQUO, KC_DEL  },
    { KC_LBRC    , XXXXXXX  , XXXXXXX, XXXXXXX , KC_PIPE, XXXXXXX, XXXXXXX, XXXXXXX  , XXXXXXX, XXXXXXX, XXXXXXX, KC_RBRC },
    { SCR_SCROLL , XXXXXXX  , XXXXXXX, XXXXXXX , LOWER  , KC_SPC , KC_SPC , RAISE_ENT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX }
  },
  [_ADJUST] = {
